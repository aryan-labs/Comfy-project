...
const Error = () => {
  return (
    <div className='flex flex-col items-center justify-center mt-40 leading-loose'>
      <h1 className='text-9xl font-semibold text-pink-500 '>404</h1>
      ...
      <NavLink to='/'><button className='mt-8 w-36 h-10 rounded-lg  text-l  bg-purple-500 text-black'>Go Back Home</button></NavLink> 
    </div>
  )
}
